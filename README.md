# Desafio realizado para a conclusão do curso de 500hrs de desenvolvimento backend pela Cubos Academy. 
Este desafio fez uso da linguagem Javascrpt, e utilizando recursos como: JWT, Express, Bcript, Knex, PostgressSQL, AWS-sdk, dentre outros.
